...
In Java folder,it contains all .java classes of exercise5. In test folder,it contains all test.java classes of exercise5.these classes contain testcases to check respective .java files
----------------------------------------------------------------------------------------------------
